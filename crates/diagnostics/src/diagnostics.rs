...
mod tests {
    ...
    async fn the_diagnostics_view_says_what_it_found(cx: &mut TestAppContext) {
        ...
        gpui::a11y_checks::assert_focusable_names_are_distinguishable(&tree, "project diagnostics");
        gpui::a11y_checks::assert_clickable_elements_are_reachable(&tree, "project diagnostics");
