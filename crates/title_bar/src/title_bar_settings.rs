...
impl Settings for TitleBarSettings {
    fn from_settings(s: &SettingsContent) -> Self {
        ...
        TitleBarSettings {
            ...
            show_onboarding_banner: content.show_onboarding_banner.unwrap_or(true),
            show_user_picture: content.show_user_picture.unwrap_or(true),
            show_branch_name: content.show_branch_name.unwrap_or(true),
            show_project_items: content.show_project_items.unwrap_or(true),
            show_sign_in: content.show_sign_in.unwrap_or(true),
            show_user_menu: content.show_user_menu.unwrap_or(true),
